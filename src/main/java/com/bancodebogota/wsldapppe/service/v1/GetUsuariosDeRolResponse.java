...
/**
 * <p>Clase Java para getUsuariosDeRolResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getUsuariosDeRolResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getUsuariosDeRolResponse", propOrder = {
    "_return"
})
public class GetUsuariosDeRolResponse {
