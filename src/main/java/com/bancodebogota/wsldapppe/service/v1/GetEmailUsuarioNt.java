...
/**
 * <p>Clase Java para getEmailUsuarioNt complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getEmailUsuarioNt"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getEmailUsuarioNt", propOrder = {
    "usuarioNT"
})
public class GetEmailUsuarioNt {
